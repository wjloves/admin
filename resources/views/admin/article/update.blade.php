...
@section('content')
    <div class="pageheader">
        <h2><i class="fa fa-home"></i> Dashboard <span>修改消息</span>
        </h2>
    </div>
            ...
            <div class="col-sm-9 col-lg-10">
                ...
                <div class="panel panel-default">
                    <div class="panel-heading">
                        ...
                        <h4 class="panel-title">修改消息</h4>
                    </div>

                    <form class="form-horizontal form-bordered" action="{{ route('article.update',['id'=>$article->id]) }}" method="POST">
                    {{ csrf_field() }}
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                  ...
                                  <input class="hide" name="thumb_img_url" id="image_path" value="{{ $article->thumb_img_url }}" type="hidden">
                                  <image id="uploadimg" class="@if( $article->thumb_img_url == null) hide @endif" width="350" height="150" src="{{ $article->thumb_img_url }}"/>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                               <textarea id="wysiwyg" class="form-control" rows="10"  name="content" placeholder="Enter text here..." >{!! $article->content !!}</textarea>
                            </div>
                        </div>

                        <div class="form-group">
                            <label for="name" class="col-md-4 control-label">标签（英文逗号分隔）</label>

                            <div class="col-md-6">
                                <input name="tags" id="tags" class="form-control" value="{{ $article->tags }}" style="display: none;">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <div class="col-md-6 col-md-offset-4">
                                 <input class="btn btn-primary" type="button" value="保存" id="articleUpdate"/>
                            </div>
                        </div>
                    </form>
                </div>
